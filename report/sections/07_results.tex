...
Bảng~\ref{tab:replicated_table5} chứng minh cấu hình $\text{Lag1}$ mang lại sự cân bằng tối ưu giữa độ chính xác và độ phức tạp đặc trưng, làm cơ sở vững chắc để nhóm triển khai các hướng mở rộng tiếp theo.
