...
\textbf{Đóng góp thực tế của bài báo:}
\begin{itemize}
    \item \textit{Về mặt giải pháp kỹ thuật:} Đưa ra một cách kết hợp thông minh giữa mô hình tuyến tính đơn giản và mô hình cây phi tuyến, chứng minh rằng không cần phải áp dụng các mạng học sâu (Deep Learning) cồng kềnh mà vẫn có thể nâng cao độ chính xác dự báo một cách rõ rệt.
    \item \textit{Về mặt vận hành hệ thống điện:} Mức cải thiện $17.00\%$ sai số RMSE có ý nghĩa kinh tế trực tiếp: giúp các kỹ sư điều độ dự báo sát nhu cầu dùng điện thực tế, từ đó cắt giảm chi phí duy trì các tổ máy phát điện dự phòng, hạn chế lãng phí năng lượng và chủ động ứng phó với các đợt cao điểm nắng nóng.
\end{itemize}

\textbf{Giới hạn của nghiên cứu:}
Kết quả nghiên cứu hiện được kiểm chứng trên tập dữ liệu của khu vực Bắc California (khí hậu Địa Trung Hải ôn hòa) và dựa trên số liệu thời tiết quan trắc thực tế đo tại trạm, chưa tính đến sai số của các bản tin dự báo khí tượng thời gian thực.

\textbf{Hướng nghiên cứu tiếp theo:}
Để tiếp tục hoàn thiện mô hình và phục vụ tốt hơn cho công tác vận hành ngoài thực tế, các hướng phát triển tiếp theo nên tập trung vào:
\begin{enumerate}
    \item \textit{Đánh giá tác động của sai số dự báo thời tiết:} Thử nghiệm mô hình với các dữ liệu dự báo khí tượng mô phỏng (NWP) có chứa sai số nhằm kiểm tra mức độ ảnh hưởng đến kết quả khi triển khai thực tế.
    ...
    \item \textit{Dự báo khoảng tin cậy thay vì chỉ dự báo một con số điểm:} Tích hợp thêm các kỹ thuật ước lượng độ bất định (như \textit{Conformal Prediction} hoặc hồi quy phân vị) vào mô hình Stacking, nhằm cung cấp khoảng dao động tải tin cậy cho người điều độ, giúp nâng cao tính an toàn trong quản lý lưới điện.
\end{enumerate}
